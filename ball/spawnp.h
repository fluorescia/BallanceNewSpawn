...
public:
	...
	virtual C_CKSTRING GetID() override { return "NewSpawn"; }
	virtual C_CKSTRING GetVersion() override { return "0.0.1"; }
	virtual C_CKSTRING GetName() override { return "NewSpawn"; }
	virtual C_CKSTRING GetAuthor() override { return "fluoresce"; }
	virtual C_CKSTRING GetDescription() override { return "\"newspawn\" or \"nsp\" to set a position. shortcut key to tp to the position but do not reset the prop. reset the prop and tp to sector if the current is not the set sector.Thanks for the help of Bug and Swung "; }
	DECLARE_BML_VERSION;
	//VxMatrix matrix;
