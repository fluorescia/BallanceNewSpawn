...
public:
	...
	virtual C_CKSTRING GetDescription() override { return "\"nsp\" to set a position. shortcut key to tp to the position. Thanks for the help of BallanceBug and Swung "; }
	DECLARE_BML_VERSION;
	//VxMatrix matrix;
